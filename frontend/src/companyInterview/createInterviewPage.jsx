      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 w-full max-w-7xl">
        ...
        {interviews.map((interview) => (
          ...
          >
            ...
            <button className="mt-5 w-full py-2 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:opacity-90 transition text-white font-semibold flex items-center justify-center gap-2"
              onClick={() => {
